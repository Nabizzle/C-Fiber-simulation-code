...
#define el el_axnode
 ...
 "el_axnode", "mV",
 "gna1_7bar_axnode", "mho/cm2",
 "gna1_8bar_axnode", "mho/cm2",
 "gkdrbar_axnode", "mho/cm2",
 "gl_axnode", "mho/cm2",
 "ena_axnode", "mV",
 "ek_axnode", "mV",
 "ina1_7_axnode", "mA/cm2",
 "ina1_8_axnode", "mA/cm2",
 "ikdr_axnode", "mA/cm2",
 "il_axnode", "mA/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 axnode C:/Users/padaw_000/Documents/Class/Bio Electric Phenomina/Final Project/Project Model/AXNODE.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ...
   ina1_8 = gna1_8bar * m1_8 * m1_8 * m1_8 * h1_8 * ( v - ena ) ;
   ikdr = gkdrbar * ndr * ndr * ndr * ndr * ( v - ek ) ;
   il = gl * ( v - el ) ;
   }
 _current += ina1_7;
 _current += ina1_8;
